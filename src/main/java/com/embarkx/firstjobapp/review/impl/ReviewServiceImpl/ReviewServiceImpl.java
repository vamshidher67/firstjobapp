package com.embarkx.firstjobapp.review.impl.ReviewServiceImpl;
...
public class ReviewServiceImpl implements ReviewService {
    ...
    public Review getReviewById(Long companyId, Long reviewId) {
          List<Review> reviews  =  reviewRepository.findAllReviewsByCompanyId(companyId);
    ...
    public boolean deleteReview(Long companyId, Long reviewId) {
        if(companyService.getCompanyById(companyId) != null
            ...
            company.getReviews().remove(review);  //removing the review from the company related, reference because review and company have a bidirectional relationship
